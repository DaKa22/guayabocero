        ...
        <div class="cs-main_header_in">
          <div class="cs-main_header_left">
            <a class="cs-site_branding cs-accent_color" href="">
              <img src="{{ asset('img/logo.png') }}" alt="Logo" class="cs-hide_dark">
          ...
          <div class="cs-main_header_right">
            <div class="cs-nav">
              <ul class="cs-nav_list">
                <li class="menu-item-has-children"><a href="#home" class="cs-smoth_scroll">INICIO</a>
                  {{-- <ul>
                    <li><a href="">Landing Version 1</a></li>
                    <li><a href="">Landing Version 2</a></li>
                    <li><a href="">Landing Version 3</a></li>
                  </ul> --}}
                </li>
                <li><a href="#about" class="cs-smoth_scroll">QUIENES SOMOS</a></li>
                <li><a href="#about" class="cs-smoth_scroll">PAQUETES</a></li>
                <li><a href="#about" class="cs-smoth_scroll">RESEÑAS</a></li>
                <li><a href="#about" class="cs-smoth_scroll">CONTACTO</a></li>
          ...
          <div class="cs-main_header_right">
            <div class="cs-toolbox">
              ...
              {{-- <span class="cs-btn cs-btn_bordered cs-modal_btn" data-modal="mint">
